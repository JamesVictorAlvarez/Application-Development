...
class _MyHomePageState extends State<MyHomePage> {
  ...
  TextEditingController colorUpdateController = TextEditingController();
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text('DB - Flutter SQLite Tutorial'),
        ),
        body: TabBarView(
          children: [
            Center(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  return Container(
                    ...
                    child: Center(
                      child: Text(
                        '[${cars[index].id}] ${cars[index].name} - ${cars[index].miles} miles - ${cars[index].color}',
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return Container(
                          ...
                          child: Center(
                            child: Text(
                              '[${carsByName[index].id}] ${carsByName[index].name} - ${carsByName[index].miles} miles - ${cars[index].color}',
                              style: TextStyle(fontSize: 18),
                            ),
                          ),
                        );
                ...
                children: <Widget>[
                  ...
                  RaisedButton(
                    ...
                    onPressed: () {
                      ...
                      String color = colorUpdateController.text;
                      _update(id, name, miles, color);
                    },
                  ),
                ],
              ),
  ...
  void _insert(name, miles, color) async {
    // row to insert
  ...
  void _update(id, name, miles, color) async {
    // row to update
    Car car = Car(id, name, miles, color);
